...
def pick_random_nodes_matching_selected(network, bins, nodes_selected, n_random, degree_aware=True, connected=False, ordered=False):
    """
...
def gen_degree_preserved_sets(nodeset, network, n_samples, bin_minimum_occupancy=30, ordered=False):
    """
    ...
    return pick_random_nodes_matching_selected(network=network, bins=bins, nodes_selected=nodeset, n_random=n_samples, ordered=ordered)